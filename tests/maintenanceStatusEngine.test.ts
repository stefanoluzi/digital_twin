...
const subassembly: Subassembly = { id: 'SUB-1', equipmentId: 'EQ-1', name: 'Rodamiento', description: '', sapId: '', active: true, criticality: 'A', source: 'LOCAL', createdAt: '2026-01-01T00:00:00Z' }
...
describe('maintenanceStatusEngine', () => {
  ...
  it('solo reinicia el ciclo con reemplazo u overhaul', () => {
    const inspection = { ...event, id: 'E-2', type: 'INSPECTION' as const, date: '2026-01-29' }
    expect(deriveSubassemblyMaintenanceState(subassembly, plan, [event, inspection], '2026-02-01').lastEventDate).toBe('2026-01-01')
  })
})

  ...
  return (
    <group>
      ...
      {Array.from({ length: count }, (_, index) => {
        ...
        return (
          <mesh key={index} position={[x, rollerCenterY, 0]} rotation={[Math.PI / 2, 0, 0]}>
            <cylinderGeometry args={[diameter / 2, diameter / 2, rollerWidth, 20]} />
      ...
      <RollerTableBearingSystem
        ...
        housingWidth={Number(asset.params.housingWidth ?? 0.35)}
        housingLength={Number(asset.params.housingLength ?? 0.45)}
        housingHeight={Number(asset.params.housingHeight ?? 0.55)}
